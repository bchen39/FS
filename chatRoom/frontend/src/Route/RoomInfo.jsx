...
/* The RoomInfo component of the Room page, as name suggests, is a page that holds the info of the room: name, 
  users currently present, and leave room button. */
const RoomInfo = ({ socket, username, room }) => {
  const [curUsers, setCurUsers] = useState([]);

  const navigate = useNavigate();

    /* Every time a new user joins, update user list. */
    useEffect(() => {
    ...
    /* Leaves room by changing local storage and requesting change of user list. */
    const leaveRoom = () => {
